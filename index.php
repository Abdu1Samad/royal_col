...
<body>
  ...
  <div id="carouselExampleFade" class="carousel slide carousel-fade carousel-container" data-bs-ride="carousel">
    <div class="carousel-inner">
      ...
      <div class="carousel-item carousel-item-2 ">
        <img
          src="https://trufitpk.netlify.app/images/carousel-images/male-img-2-min.png"
  ...
  <section class="new-arival-section">
    <div class="new-arrival-container row g-0">
      <!-- php  -->
      <?php
          while($row = mysqli_fetch_Assoc($new_arrival_query)){
         ?>

      <div class="products-card col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3">
        <a class="product-id-fetching-anchor" href="product-details.php?product_id=<?php echo $row['product_id']?>">
          <div class="card-content">
            ...
            <div class="card-desription">
              <p>
                <?php echo substr($row['product-desc'], 0, 80)?>...
              </p>
            </div>
  ...
  <div class="category-products-grid-container">
    <div class="category-product-grid-items" id="category-products-box-1">
      <img
        src="https://media.istockphoto.com/id/1202257499/photo/happy-casual-guy-looking-to-side-and-fixing-glasses.jpg?s=612x612&w=0&k=20&c=9By5t2quyhKoiJMZNn1lVtIt487kQfOig9Sceqe4jd8="
        alt="">
    ...
    <div class="category-product-grid-items" id="category-products-box-2">
      <img
        src="https://media.istockphoto.com/id/1162158579/photo/top-view-of-casual-orange-suede-trainers-on-grey-wooden-planks.jpg?b=1&s=612x612&w=0&k=20&c=ZdbaI8Tz1PNBfYLy1jtmoAA5EtGlfjzlf3HI9SjUQa0="
        alt="">
    ...
    <div class="category-product-grid-items" id="category-products-box-4">
      <img
        src="https://plus.unsplash.com/premium_photo-1676822252274-f81d2d6aab23?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8YmVhdXR5JTIwcHJvZHVjdHMlMjB3aXRoJTIwY29sb3IlMjBiYWNrZ3JvdW5kfGVufDB8fDB8fHww"
        alt="">
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item active carousel-main">
          <div class="testimonial-content-1">
            ...
            <p>"Shopping at ROYAL COLLECTION is a pleasure! Their user-friendly website made finding what I needed a
              breeze, and the variety of products is outstanding. I couldn't be happier with my purchase."
            </p>
          </div>
        </div>
        <div class="carousel-item  carousel-main">
          <div class="testimonial-content-1">
            ...
            <p>"I've been a loyal customer of ROYAL COLLECTION for a while now. The selection of products is vast, the
              prices are competitive, and the shipping is always on time. It's a one-stop shop for all my needs!"
            </p>
          </div>
        </div>
        <div class="carousel-item  carousel-main">
          <div class="testimonial-content-1">
            ...
            <p>"I've shopped online extensively, and ROYAL COLLECTION stands out as one of the best. Their customer
              service is top-notch, and the products are of the highest quality. I highly recommend them to anyone
              looking for great deals and a seamless shopping experience."
            </p>
          </div>
        </div>
        <div class="carousel-item  carousel-main">
          <div class="testimonial-content-1">
            ...
            <p>"I recently ordered from ROYAL COLLECTION and was impressed with the product's quality and the quick
              delivery. The website is well-organized, making it easy to find what I was looking for. This is my new
        ...
        <div class="carousel-item  carousel-main">
          <div class="testimonial-content-1">
            ...
            <p>"I am beyond thrilled with my recent purchase from ROYAL COLLECTION. The product quality exceeded my
              expectations, and the speedy delivery made my shopping experience truly exceptional. I'll definitely be
              back for more!"
            </p>
          </div>
        </div>
